...
Android application for drawing on blank sheet that extends View class with custom view.
...
1. Import project to Android studio:
    - Click on **Checkout from Version Control** (on Welcome screen, or in Toolbar - **VCS**) - **Git** in URL field set **https://github.com/llukina/Picasso** or
...
![Alt text](Screenshot_1.png?raw=true "Set Color")
![Alt text](Screenshot_2.png?raw=true "Set Line Width")
